...
2. Go to LinkedIn, log into your account and export a JSON file using the extension. ![alt text](image.png)
...
3. create a ```linkedin_cookie.json``` file and upload your linkedin session cookie from this extension https://chromewebstore.google.com/detail/export-cookie-json-file-f/nmckokihipjgplolmcmjakknndddifde.
